...
export const BUSINESS_CATEGORIES: Record<string, string[]> = {
  cogs: ["domestic_manufacturing", "international_manufacturing", "domestic_supplier", "overseas_supplier", "raw_materials", "custom_parts"],
  ...
  contractor_payments: ["freelance_labor", "consulting", "accounting", "marketing_management", "other"],
  ...
  transfer: ["credit_card_payment", "owner_transfer", "internal_transfer", "loan_repayment", "platform_payout", "owner_contribution", "customer_payment"],
  revenue: [],
};
